...
-- This script completely rebuilds the user creation system to fix the company name issue
...
WHERE company_name IN ('New Company', 'Your Company', 'new company', 'your company', 'undefined')
   ...
   OR company_name = email; -- Fix cases where company_name is set to email
